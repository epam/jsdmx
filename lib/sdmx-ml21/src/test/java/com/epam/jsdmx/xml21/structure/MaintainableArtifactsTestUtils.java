...
public final class MaintainableArtifactsTestUtils {
    ...
    public static DataConstraintImpl buildDataConstraint() {
        ...
        memberSelection1.setSelectionValues(List.of(localisedMemberValue, selectionValue1));
    ...
    private static void fillComponents(AttributeDescriptorImpl attributeDescriptor) {
        ...
        dimensionRelationship.setDimensions(List.of("DIM1"));
        dimensionRelationship.setGroupKeys(List.of("GroupDimensionDescriptor2"));
        dataAttribute.setAttributeRelationship(dimensionRelationship);
    ...
    public static HierarchyImpl buildHierarchy() {
        ...
        level.setId("levId");
        level.setCodeFormat(List.of(fillListOfCodingFormats().get(0), fillListOfCodingFormats().get(1), fillListOfCodingFormats().get(7)));
    ...
    public static HierarchyImpl buildHierarchyWithInnerHierarchy() {
        ...
        level.setName(new InternationalString("hierarchy name"));
        level.setId("levId");
        level.setCodeFormat(List.of(fillListOfCodingFormats().get(0), fillListOfCodingFormats().get(1)));
        hierarchy.setLevel(level);
    ...
    private static List<GeoFeatureSetCode> getGeoFeatureSetCodes() {
        ...
        geoFeatureSetCode2.setHierarchy(List.of(geoFeatureSetCode1));
    ...
    private static List<GridCode> getGridCodes() {
        ...
        gridCode2.setHierarchy(List.of(gridCode));
