...
import static com.epam.jsdmx.xml21.structure.TestUtils.HIERARCHIES_NAMES_XML;
...
class HierarchicalCodelistWriterTest extends BaseXmlWriterTest {
    ...
    void writeHierarchy() throws IOException, SAXException {
        ...
        HierarchicalCodelistWriter hierarchyWriter = createHierarchyWriter();
        ...
        sdmxSourceCompatibilityTester.test(actualString, SdmxBeans::getHierarchicalCodelists);
    }
    ...
    void writeHierarchyWithNull() throws IOException, SAXException {
        ...
        ByteArrayOutputStream actual = new ByteArrayOutputStream();
        Xml21StructureWriter xmlStructureWriter =
            new Xml21StructureWriter(actual, List.of(hierarchyWriter), new HeaderWriter(defaultHeaderProvider), false);
