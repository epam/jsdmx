...
class DataConsumerSchemeWriterTest extends BaseXmlWriterTest {
    ...
    void writeDataConsumerScheme() throws IOException, SAXException {
        ...
        DataConsumerSchemeWriter dataConsumerSchemeWriter = createDataConsumerSchemeWriter();
        ...
        InputStream resourceAsStream = this.getClass().getResourceAsStream(DATA_CONSUMER_SCHEME_XML);
