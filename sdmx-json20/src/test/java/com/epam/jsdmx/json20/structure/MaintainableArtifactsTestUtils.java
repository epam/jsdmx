package com.epam.jsdmx.json20.structure;
...
import com.epam.jsdmx.json20.structure.reader.AnnotableReader;
import com.epam.jsdmx.json20.structure.reader.CategorisationReader;
import com.epam.jsdmx.json20.structure.reader.CategorySchemeReader;
import com.epam.jsdmx.json20.structure.reader.CodeImplReader;
import com.epam.jsdmx.json20.structure.reader.CodelistExtensionReader;
import com.epam.jsdmx.json20.structure.reader.CodelistReader;
import com.epam.jsdmx.json20.structure.reader.ConceptSchemeReader;
import com.epam.jsdmx.json20.structure.reader.ContactReader;
import com.epam.jsdmx.json20.structure.reader.CubeRegionReader;
import com.epam.jsdmx.json20.structure.reader.DataConstraintReader;
import com.epam.jsdmx.json20.structure.reader.DataFlowReader;
import com.epam.jsdmx.json20.structure.reader.DataKeySetReader;
import com.epam.jsdmx.json20.structure.reader.DataReader;
import com.epam.jsdmx.json20.structure.reader.DataStructureDefinitionReader;
import com.epam.jsdmx.json20.structure.reader.HierarchyReader;
import com.epam.jsdmx.json20.structure.reader.IdentifiableReader;
import com.epam.jsdmx.json20.structure.reader.JsonStructureReader;
import com.epam.jsdmx.json20.structure.reader.MemberSelectionReader;
import com.epam.jsdmx.json20.structure.reader.MetaDataStructureDefinitionReader;
import com.epam.jsdmx.json20.structure.reader.MetaReader;
import com.epam.jsdmx.json20.structure.reader.MetadataFlowReader;
import com.epam.jsdmx.json20.structure.reader.NameableReader;
import com.epam.jsdmx.json20.structure.reader.OrganisationReader;
import com.epam.jsdmx.json20.structure.reader.ReleaseCalendarReader;
import com.epam.jsdmx.json20.structure.reader.RepresentationMapReader;
import com.epam.jsdmx.json20.structure.reader.StructureMapReader;
import com.epam.jsdmx.json20.structure.reader.VersionableReader;
import com.epam.jsdmx.json20.structure.writer.AnnotableWriter;
import com.epam.jsdmx.json20.structure.writer.AttributeListWriter;
import com.epam.jsdmx.json20.structure.writer.CategorisationWriter;
import com.epam.jsdmx.json20.structure.writer.CategorySchemeWriter;
import com.epam.jsdmx.json20.structure.writer.CodeWriterImpl;
import com.epam.jsdmx.json20.structure.writer.CodelistExtensionWriter;
import com.epam.jsdmx.json20.structure.writer.CodelistWriter;
import com.epam.jsdmx.json20.structure.writer.ComponentWriter;
import com.epam.jsdmx.json20.structure.writer.ConceptRoleWriter;
import com.epam.jsdmx.json20.structure.writer.ConceptSchemeWriter;
import com.epam.jsdmx.json20.structure.writer.ContactsWriter;
import com.epam.jsdmx.json20.structure.writer.CubeRegionWriter;
import com.epam.jsdmx.json20.structure.writer.DataConstraintWriter;
import com.epam.jsdmx.json20.structure.writer.DataKeySetsWriter;
import com.epam.jsdmx.json20.structure.writer.DataStructureDefinitionWriter;
import com.epam.jsdmx.json20.structure.writer.DataflowWriter;
import com.epam.jsdmx.json20.structure.writer.DateTimeWriter;
import com.epam.jsdmx.json20.structure.writer.DimensionListWriter;
import com.epam.jsdmx.json20.structure.writer.GroupDimensionListWriter;
import com.epam.jsdmx.json20.structure.writer.HierarchyWriter;
import com.epam.jsdmx.json20.structure.writer.IdentifiableWriter;
import com.epam.jsdmx.json20.structure.writer.JsonStructureWriter;
import com.epam.jsdmx.json20.structure.writer.LinksWriter;
import com.epam.jsdmx.json20.structure.writer.MeasureListWriter;
import com.epam.jsdmx.json20.structure.writer.MemberSelectionWriter;
import com.epam.jsdmx.json20.structure.writer.MetaWriter;
import com.epam.jsdmx.json20.structure.writer.MetadataStructureDefinitionWriter;
import com.epam.jsdmx.json20.structure.writer.MetadataflowWriter;
import com.epam.jsdmx.json20.structure.writer.NameableWriter;
import com.epam.jsdmx.json20.structure.writer.OrganisationWriter;
import com.epam.jsdmx.json20.structure.writer.RepresentationMapWriter;
import com.epam.jsdmx.json20.structure.writer.RepresentationWriter;
import com.epam.jsdmx.json20.structure.writer.StructureMapWriter;
import com.epam.jsdmx.json20.structure.writer.VersionableWriter;
...
public final class MaintainableArtifactsTestUtils {
    ...
    public static DataConstraintImpl buildDataConstraint() {
        ...
        dataConstraint.setCubeRegions(List.of(createCubeRegion()));
    ...
    private static void fillComponents(AttributeDescriptorImpl attributeDescriptor) {
        ...
        final var typeFacet = new BaseFacetImpl();
        typeFacet.setValueType(FacetValueType.ALPHA_NUMERIC);
        final var multilingualFacet = new BaseFacetImpl();
        multilingualFacet.setType(FacetType.IS_MULTILINGUAL);
        multilingualFacet.setValue("false");
    ...
    private static void fillMeasureComponents(MeasureDescriptorImpl measureDescriptor) {
        ...
        final var baseFacet = new BaseFacetImpl();
        baseFacet.setValueType(FacetValueType.BASIC_TIME_PERIOD);
        ...
        measure.setLocalRepresentation(new BaseTextFormatRepresentationImpl(Set.of(baseFacet, multilingualFacet)));
    ...
    public static VersionableReader getVersionableReader() {
        final NameableReader nameableReader = getNameableReader();
        return new VersionableReader(nameableReader);
    }

    public static NameableReader getNameableReader() {
        final IdentifiableReader identifiableReader = getIdentifiableReader();
        return new NameableReader(identifiableReader);
    }

    public static CodelistExtensionReader getCodelistExtensionReader() {
        return new CodelistExtensionReader();
    }

    public static AnnotableReader getAnnotableReader() {
        return new AnnotableReader();
    }

    public static IdentifiableReader getIdentifiableReader() {
        final var annotableReader = new AnnotableReader();
        return new IdentifiableReader(annotableReader);
    }

    public static StructureReader getStructureReader() {
        DataReader dataReader = createStructureDataReader();
        var headerReader = new MetaReader();
        return new JsonStructureReader(dataReader, headerReader);
    }
    ...
    public static MemberSelectionReader getMemberSelectionReader() {
    ...
    public static CodelistExtensionWriter getCodelistExtensionWriter() {
        return new CodelistExtensionWriter(getUrnAdapter());
    }

    public static ReferenceAdapter getUrnAdapter() {
        return new DefaultReferenceAdapter();
    }

    public static TimeDimensionLocalRepresentationAdapter getDsdAdapter() {
        return new StubDataStructureLocalRepresentationAdapter();
    }
    ...
    public static MemberSelectionWriter getMemberSelectionWriter() {
        return new MemberSelectionWriter(getDateTimeWriter());
    }

    public static DateTimeWriter getDateTimeWriter() {
        return new DateTimeWriter();
    }

    public static DataKeySetsWriter getDataKeySetsWriter() {
    ...
    public static CubeRegionWriter getCubeRegionWriter() {
        return new CubeRegionWriter(getMemberSelectionWriter(), getDateTimeWriter(), getAnnotableWriter());
    }

    public static DataConstraintWriter getDataConstraintWriter() {
    ...
    private static DataReader createStructureDataReader() {
        final var annotableReader = new AnnotableReader();
        final var identifiableReader = new IdentifiableReader(annotableReader);
        final var nameableReader = new NameableReader(identifiableReader);
        final var versionableReader = new VersionableReader(nameableReader);

        final var categorisationReader = new CategorisationReader(versionableReader);
        final var categorySchemeReader = new CategorySchemeReader(versionableReader, nameableReader);
        final var conceptSchemeReader = new ConceptSchemeReader(versionableReader, nameableReader);
        final var codelistExtensionReader = new CodelistExtensionReader();
        final var codeImplReader = new CodeImplReader();
        final var codeListReader = new CodelistReader(versionableReader, nameableReader, codelistExtensionReader, codeImplReader);
        final var dataFlowReader = new DataFlowReader(versionableReader);
        final var dataStructureDefinitionReader = new DataStructureDefinitionReader(versionableReader, identifiableReader);
        final var hierarchyReader = new HierarchyReader(versionableReader, identifiableReader, nameableReader);
        final var metadataFlowReader = new MetadataFlowReader(versionableReader);
        final var metaDataStructureDefinitionReader = new MetaDataStructureDefinitionReader(versionableReader, identifiableReader);
        final var representationMapReader = new RepresentationMapReader(versionableReader);
        final var structureMapReader = new StructureMapReader(versionableReader, identifiableReader, annotableReader);
        final var releaseCalendarReader = getReleaseCalendarReader();
        final var dataKeySetReader = getDataKeySetReader();
        final var cubeRegionReader = getCubeRegionReader();
        final var dataConstraintReader = new DataConstraintReader(versionableReader, releaseCalendarReader, dataKeySetReader, cubeRegionReader);

        return new DataReader(
            List.of(
                categorisationReader,
                categorySchemeReader,
                conceptSchemeReader,
                codeListReader,
                dataFlowReader,
                dataStructureDefinitionReader,
                hierarchyReader,
                metadataFlowReader,
                metaDataStructureDefinitionReader,
                representationMapReader,
                structureMapReader,
                dataConstraintReader
            )
        );
    }

    public static JsonStructureWriter createStructureWriter(
        ByteArrayOutputStream outputStream,
        ObjectMapper mapper,
        DefaultHeaderProvider defaultHeaderProvider) {
        var urnAdapter = new DefaultReferenceAdapter();
        var linksWriter = new LinksWriter(urnAdapter);
        var representationWriter = new RepresentationWriter(urnAdapter);
        var headerWriter = new MetaWriter(List.of(), defaultHeaderProvider);
        ...
        var componentWriter = new ComponentWriter(identifiableWriter, representationWriter, urnAdapter);
        var conceptRoleWriter = new ConceptRoleWriter(urnAdapter);
        var attributeListWriter = new AttributeListWriter(annotableWriter, conceptRoleWriter, componentWriter);
        var dimensionListWriter = new DimensionListWriter(annotableWriter, conceptRoleWriter, componentWriter);
        var groupDimensionListWriter = new GroupDimensionListWriter(identifiableWriter);
        var measureListWriter = new MeasureListWriter(annotableWriter, conceptRoleWriter, componentWriter);
        final var categorisationWriter = new CategorisationWriter(versionableWriter, linksWriter, urnAdapter);
        ...
        final var extensionWriter = new CodelistExtensionWriter(urnAdapter);
        final var codeListWriter = new CodelistWriter(versionableWriter, linksWriter, codeImplWriter, extensionWriter, nameableWriter);
        final var dataFlowWriter = new DataflowWriter(versionableWriter, linksWriter, urnAdapter);
        final var dataStructureDefinitionWriter = new DataStructureDefinitionWriter(
            versionableWriter, linksWriter, attributeListWriter, dimensionListWriter, groupDimensionListWriter, measureListWriter, urnAdapter,
            new StubDataStructureLocalRepresentationAdapter()
        );
        final var hierarchyWriter = new HierarchyWriter(versionableWriter, linksWriter, identifiableWriter, nameableWriter, urnAdapter);
        final var metadataFlowWriter = new MetadataflowWriter(versionableWriter, linksWriter, urnAdapter);
        final var metadataStructureDefinitionWriter = new MetadataStructureDefinitionWriter(versionableWriter, linksWriter, componentWriter,
            identifiableWriter
        );
        final var representationMapWriter = new RepresentationMapWriter(versionableWriter, linksWriter, annotableWriter, urnAdapter);
        final var structureMapWriter = new StructureMapWriter(versionableWriter, linksWriter, annotableWriter, identifiableWriter, urnAdapter);

        final var dateTimeWriter = new DateTimeWriter();
        final var memberSelectionWriter = new MemberSelectionWriter(dateTimeWriter);
        final var cubeRegionWriter = new CubeRegionWriter(memberSelectionWriter, dateTimeWriter, annotableWriter);
        final var dataKeySetsWriter = new DataKeySetsWriter(annotableWriter, memberSelectionWriter, dateTimeWriter);
        final var dataConstraintWriter = new DataConstraintWriter(versionableWriter, linksWriter, cubeRegionWriter, dataKeySetsWriter, urnAdapter);

        return new JsonStructureWriter(
            mapper,
            outputStream,
            headerWriter,
            List.of(categorisationWriter, categorySchemeWriter, codeListWriter, conceptSchemeWriter,
                dataStructureDefinitionWriter, hierarchyWriter, metadataFlowWriter, metadataStructureDefinitionWriter, representationMapWriter, dataFlowWriter,
                structureMapWriter, dataConstraintWriter
            )
        );
    }
    ...
    private static List<MetadataTargetRegion> createMetadataTargetRegions(boolean isJson) {
        ...
        List<MemberSelection> memberSelectionList = getMemberSelections(false, isJson);
    ...
    private static List<MemberSelection> getMemberSelections(boolean isSimple, boolean isJson) {
        ...
        memberSelection.setSelectionValues(List.of(memberValue));
    ...
    private static CubeRegion createCubeRegion() {
        LocalisedMemberValueImpl selectionValue1 = new LocalisedMemberValueImpl();
        selectionValue1.setValue("selectionValue1");
        selectionValue1.setLocale("en");
    ...
    public static DataConstraint buildDataConstraintXml() {
        DataConstraintImpl dataConstraint = new DataConstraintImpl();
        setMaintainableArtefact(dataConstraint);
        dataConstraint.setConstraintRoleType(ConstraintRoleType.ALLOWABLE_CONTENT);
        CubeRegionImpl cubeRegion = new CubeRegionImpl();
        ...
        cubeRegionKey.setComponentId("CubeReg");
        cubeRegionKey.setIncluded(true);
        cubeRegionKey.setRemovePrefix(true);
        cubeRegionKey.setValidTo(Instant.parse("2022-07-17T10:11:16Z"));
        cubeRegionKey.setValidFrom(Instant.parse("2022-07-17T10:11:16Z"));
        cubeRegionKey.setSelectionValues(List.of(getMemberValue()));
        cubeRegion.setCubeRegionKeys(List.of(cubeRegionKey));
        cubeRegion.setMemberSelections(getMemberSelections(true, false));
        ...
        componentValue.setValue("Value");
        dataKey.setKeyValues(List.of(componentValue));
        dataKey.setMemberSelections(getMemberSelections(true, false));
        dataKey.setValidFrom(Instant.parse("2022-07-17T10:11:16Z"));
        dataKey.setValidTo(Instant.parse("2022-07-17T10:11:16Z"));
        dataKeySet.setKeys(List.of(dataKey));
        dataConstraint.setDataContentKeys(List.of(dataKeySet));
        IdentifiableArtefactReferenceImpl maintainableArtefactReference = new IdentifiableArtefactReferenceImpl(
            "urn:sdmx:org.sdmx.infomodel.base.DataProvider=IMF:DATA_PROVIDERS(1.0).PR");
        dataConstraint.setConstrainedArtefacts(List.of(maintainableArtefactReference));
        return dataConstraint;
    }
    ...
    public static ContactReader getContactReader() {
        return new ContactReader();
    }

    public static OrganisationReader getOrganisationReader() {
        return new OrganisationReader(getContactReader(), getNameableReader());
    }

    public static ReleaseCalendarReader getReleaseCalendarReader() {
        return new ReleaseCalendarReader();
    }

    public static DataKeySetReader getDataKeySetReader() {
        return new DataKeySetReader(getAnnotableReader(), getMemberSelectionReader());
    }

    public static CubeRegionReader getCubeRegionReader() {
        return new CubeRegionReader(getMemberSelectionReader(), getAnnotableReader());
    }

    public static CodeImplReader getCodeImplReader() {
