...
import static com.epam.jsdmx.json10.structure.writer.StructureUtils.SCHEMA;
...
class Json10StructureWriterTest {
    ...
    private Json10StructureWriter jsonStructureWriter;

    @BeforeEach
    @SneakyThrows
    void setup() {
        jsonStructureWriter = MaintainableArtifactsTestUtils.createStructureWriter(
            outputStream, objectMapper, defaultHeaderProvider);
    ...
    @Test
    void writeArtefactsToJson() throws IOException {
    ...
    @Test
    void writeEmptyArtefactsToJson() throws IOException {
    ...
    private void fillCategoryScheme(ArtefactsImpl artefacts) {
        ...
        artefacts.setCategorySchemes(Set.of(categoryScheme));
    }
    ...
    private void fillMDSD(ArtefactsImpl artefacts) {
        ...
        artefacts.setMetadataStructureDefinitions(Set.of(metadataStructureDefinition));
    }
    ...
    private void fillDataFlow(ArtefactsImpl artefacts) {
        ...
        dataflow.setId("DF1");
        artefacts.setDataflows(Set.of(dataflow));
    }
    ...
    private void fillCategorisation(ArtefactsImpl artefacts) {
        ...
        artefacts.setCategorisations(Set.of(categorisation));
    }
    ...
    private void fillCodeList(ArtefactsImpl artefacts) {
        ...
        artefacts.setCodelists(Set.of(codeList));
    }
    ...
    private void fillDSD(ArtefactsImpl artefacts) {
        ...
        artefacts.setDataStructures(Set.of(dataStructureDefinition));
    }
    ...
    private void fillHierarchy(ArtefactsImpl artefacts) {
        ...
        artefacts.setHierarchies(Set.of(hierarchy));
    }
    ...
    private void fillMetadataFlow(ArtefactsImpl artefacts) {
        ...
        artefacts.setMetadataflows(Set.of(metadataflow));
    }
    ...
    private void fillRepresentationMap(ArtefactsImpl artefacts) {
        ...
        artefacts.setRepresentationMaps(Set.of(representationMap));
    }
}
