...
public class OrganisationWriter {
    ...
    <T extends Organisation<?>> void writeOrganisation(JsonGenerator jsonGenerator, List<? extends T> organisationItems, String organisationName)
            throws IOException {
    ...
    private <T extends Organisation<?>> void writeOrganisation(JsonGenerator jsonGenerator, Map<String, String> parentIdWithHierarchy, T organisation)
            throws IOException {
