...
public final class XmlConstants {
    ...
    public static final String SCHEMAS_V_3_0_MESSAGE = "http://www.sdmx.org/resources/sdmxml/schemas/v3_0/message";
    public static final String SCHEMAS_V_3_0_STRUCTURE = "http://www.sdmx.org/resources/sdmxml/schemas/v3_0/structure";
    ...
    public static final String SS_NAMESPACE = "http://www.sdmx.org/resources/sdmxml/schemas/v3_0/data/structurespecific";
    ...
    public static final BidiMap<ResolvePeriod, String> RESOLVE_PERIOD_STRING_MAP = STRING_RESOLVE_PERIOD_MAP.inverseBidiMap();

    public static final BidiMap<String, EpochPeriodType> STRING_EPOCH_PERIOD_MAP = new DualHashBidiMap<>();
    public static final BidiMap<EpochPeriodType, String> EPOCH_PERIOD_STRING_MAP = STRING_EPOCH_PERIOD_MAP.inverseBidiMap();
    ...
    public static final String GEO_FEATURE_SET_CODE = "GeoFeatureSetCode";
    public static final String VALUE_LOWER = "value";

    public static final String GEOGRID_CODELIST_TYPE = "GeoGridCodelist";
    public static final String GRID_DEFINITION = "GridDefinition";
    public static final String GEO_GRID_CODES = "GeoGridCode";
    public static final String GEO_CELL = "GeoCell";
    public static final BidiMap<String, String> MAP_CODING_FORMAT = MAP_FACET_TYPE.inverseBidiMap();
