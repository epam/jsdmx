...
class XmlStructureWriterTest extends BaseXmlWriterTest {
    ...
    void writeAll() throws IOException, SAXException {
        ...
        XmlStructureWriter xmlStructureWriter = new XmlStructureWriter(
            ...
            List.of(
                ...
                createMetadataflowWriter(),
                createMetadataStructureDefinitionWriter(),
                createHierarchyWriter(),
                createRepresentationMapWriter(),
                createStructureMapWriter(),
                createDataConstraintWriter()
            ),
            headerWriter,
            true
        );
